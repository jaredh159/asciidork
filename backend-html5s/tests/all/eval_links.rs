...
assert_html!(
  ...
  html! {r#"
    ...
    <p><a href="https://example.org/dist/info.adoc" class="bare include">https://example.org/dist/info.adoc</a></p>
...
//   "#},
//   html! {r#"
//     <p>(<a class="bare" href="http://foo.com">http://foo.com</a>) is bar.</p>
//     <p>The homepage for Asciidoctor is <a class="bare" href="https://asciidoctor.org">https://asciidoctor.org</a>.</p>
//     <p>Check out <a class="bare" href="https://asciidoctor.org">https://asciidoctor.org</a>!</p>
//     <p>Is the homepage for Asciidoctor <a class="bare" href="https://asciidoctor.org">https://asciidoctor.org</a>?</p>
//     <p>Asciidoctor is a Ruby-based AsciiDoc processor (see <a class="bare" href="https://asciidoctor.org">https://asciidoctor.org</a>)</p>
//     <p>(The homepage for Asciidoctor is <a class="bare" href="https://asciidoctor.org">https://asciidoctor.org</a>.)</p>
//     <p>(Check out <a class="bare" href="https://asciidoctor.org">https://asciidoctor.org</a>!)</p>
//     <p>(Is the homepage for Asciidoctor <a class="bare" href="https://asciidoctor.org">https://asciidoctor.org</a>?)</p>
//     <p><a class="bare" href="https://asciidoctor.org">https://asciidoctor.org</a>; where text gets parsed</p>
//     <p><a class="bare" href="https://asciidoctor.org">https://asciidoctor.org</a>: where text gets parsed</p>
//     <p>(<a class="bare" href="https://asciidoctor.org">https://asciidoctor.org</a>): where text gets parsed</p>
//     <p>(from <a class="bare" href="https://asciidoctor.org">https://asciidoctor.org</a>): where text gets parsed</p>
//     <p>(<a class="bare" href="https://asciidoctor.org">https://asciidoctor.org</a>); where text gets parsed</p>
//     <p>(from <a class="bare" href="https://asciidoctor.org">https://asciidoctor.org</a>); where text gets parsed</p>
//   "#}
// );
...
//     <p>"<a class="bare" href="https://asciidoctor.org">https://asciidoctor.org</a>"</p>
//     <p>'<a class="bare" href="https://asciidoctor.org">https://asciidoctor.org</a>'</p>
...
//     <p><a class="bare" href="http://a.com/b/dev@foo.com">http://a.com/b/dev@foo.com</a></p>
//   "#}
// );
//
assert_html!(
  ...
  "#},
  raw_html! {r#"
    <p>Code is at <a href="http://github.com/foo" class="bare">http://github.com/foo</a>
    which is a github organization.</p><p>link:http://foo.com</p><p>Foo link:https://example.com
    [] is bar.</p><p>Foo link:https://example.com?q=foo bar[] is bar.</p><p>Foo <a href="https://example.com?q=foo%20bar" class="bare">https://example.com?q=foo%20bar</a> is bar.</p><p>Foo: &lt;<strong><a href="https://foo.com/bar" class="bare">https://foo.com/bar</a></strong>&gt;</p><p><a href="http://foo.com">foo, bar = baz</a></p><p><a href="http://foo.com">foo, bar, baz</a></p>"#}
);
//
// assert_html!(
...
//     <p><a class="external" href="http://google.com" target="_blank" rel="noopener">Google</a></p>
//     <p><a class="bare" href="http://a.com?b=c:1,2b,">http://a.com?b=c:1,2b,</a></p>
//     <p><a class="bare" href="http://a.com?b=c:1,2b,">http://a.com?b=c:1,2b,</a></p>
//     <p><a href="http://a.com?b=c:1,2b,">Roboto,400</a></p>
//     <p><a id="roboto-regular" class="bare font" href="http://example.com">http://example.com</a></p>
...
//     <p><a class="bare" href="irc://irc.freenode.net">irc://irc.freenode.net</a></p>
