...
assert_html!(
  ...
  html! {r##"
    ...
    <div class="ulist"><ul><li><a href="using-.net-web-services.html">Using .NET web services</a></li><li><a href="asciidoctor.1.html">Asciidoctor Manual</a></li><li><a href="path/to/document.html">Document Title</a></li></ul></div>
    <div class="ulist"><ul><li><a href="using-.net-web-services">Using .NET web services</a></li><li><a href="asciidoctor.1">Asciidoctor Manual</a></li><li><a href="document.html">Document Title</a></li><li><a href="path/to/document.html">Document Title</a></li><li><a href="include.d/document.html">Document Title</a></li></ul></div>
    <div class="ulist"><ul><li><a href="refcard.pdf">Refcard</a></li><li><a href="asciidoctor.1">Asciidoctor Manual</a></li><li><a href="#sections.d/first">First Section</a></li></ul></div>
  "##}
);
...
assert_html!(
  ...
  "#},
  html! {r##"
    <section class="doc-section level-1"><h2 id="ch1">Chapter One</h2><p>So it begins.</p>
    <p>Read <a href="#ch2">Chapter 2</a>.</p></section>
    <section class="doc-section level-1"><h2 id="ch2">Chapter 2</h2><p>The plot thickens.</p></section>
    <section class="doc-section level-1"><h2 id="ch3">Chapter 3</h2><p>The plot runs its course, predictably.</p></section>
  "##}
);
//
// assert_html!(
