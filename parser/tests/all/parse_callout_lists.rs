  ...
  assert_callout_list(
    ...
    &[
      ListItem {
        ...
        type_meta: ListItemTypeMeta::Callout(svec![Callout::new(0, 0, 1, false)]),
        ..empty_list_item!()
      },
      ListItem {
        ...
        type_meta: ListItemTypeMeta::Callout(svec![Callout::new(0, 1, 2, false)]),
        ..empty_list_item!()
      },
    ],
  );
  ...
  assert_callout_list(
    ...
    &[
      ...
      ListItem {
        ...
        type_meta: ListItemTypeMeta::Callout(svec![
          Callout::new(0, 1, 2, false),
          Callout::new(0, 2, 2, false),
        ]),
        ..empty_list_item!()
      },
    ],
  ...
  assert_callout_list(
    ...
    &[
      ListItem {
        ...
        type_meta: ListItemTypeMeta::Callout(svec![Callout::new(0, 2, 1, false)]),
        ..empty_list_item!()
      },
      ListItem {
        marker: ListMarker::Callout(Some(2)),
        ...
        type_meta: ListItemTypeMeta::Callout(svec![Callout::new(0, 0, 2, false)]),
        ..empty_list_item!()
      },
      ListItem {
        ...
        type_meta: ListItemTypeMeta::Callout(svec![Callout::new(0, 1, 3, false)]),
        ..empty_list_item!()
      },
    ],
  );
  ...
  assert_callout_list(
    ...
    &[
      ...
      ListItem {
        ...
        principle: just!("Describe the third line", 191..214),
        type_meta: ListItemTypeMeta::Callout(svec![Callout::new(0, 2, 3, false)]),
        ..empty_list_item!()
      },
    ],
  );
...
fn test_finish_parsing_colist_advances() {
  ...
  assert_callout_list(
    ...
    &[ListItem {
      ...
      type_meta: ListItemTypeMeta::Callout(svec![Callout::new(1, 0, 1, false)]),
      ..empty_list_item!()
    }],
  );
}
